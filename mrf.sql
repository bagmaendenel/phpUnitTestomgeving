...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 14 apr 2016 om 15:48
-- Serverversie: 5.6.16
-- PHP-versie: 5.5.11
...
--
-- Tabelstructuur voor tabel `contractors`
--

CREATE TABLE IF NOT EXISTS `contractors` (
  `contractor_id` int(11) NOT NULL AUTO_INCREMENT,
  `contractor_name` varchar(52) NOT NULL,
  PRIMARY KEY (`contractor_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14 ;

--
-- Gegevens worden geëxporteerd voor tabel `contractors`
--

INSERT INTO `contractors` (`contractor_id`, `contractor_name`) VALUES
(1, 'Bouwbedrijf Hendriks'),
(2, 'Dael Telecom b.v.'),
(3, 'Heijmans techniek & Mobiliteit b.v.'),
(4, 'Liandon'),
(5, 'Marconi Oranje Constructies b.v.'),
(6, 'Mobilis Telecom b.v.'),
(7, 'Network Management Services b.v.'),
(8, 'Spie'),
(9, 'C4Telecom'),
(10, 'TWS Technologies b.v.'),
(11, 'VWNB'),
(12, 'WL Winet b.v.'),
(13, 'Imtech');
...
INSERT INTO `locations` (`location_id`, `type`) VALUES
(1, 'mast or tower'),
(2, 'building'),
(3, 'advertising pole'),
(4, 'chimney'),
(5, 'church or monument'),
(6, 'sport field'),
(7, 'silo'),
(8, 'factory'),
(9, 'store'),
...
CREATE TABLE IF NOT EXISTS `manufacturer` (
  ...
  `manufacturer_name` varchar(42) NOT NULL,
...
(1, 'lars@larsrasmussen.nl', '$2y$10$W9W99ZS5MYxKmN9n2A2m7.2LykCbkiolWdiE2nimc4Fe7/KjZ0Npq', 'hallo', 'hallo', 'hallo', '1');
